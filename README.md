...
* Since this project employs GraphQL stack, you need to download the [schema](https://www.apollographql.com/docs/tutorial/schema/) first:
    ...
    * Or you can run this command as alternative.
        ...
        ```
* Set `DADS_JWT` key in `gradle.properties` file (either in your user home directory or in the project's root folder) with following key:
```
eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhcHAiOiJEYWRzISIsInR5cGUiOiJVc2VyIn0.46oGvluHExsPIOS9d925RNYrk_Y9eke0Zm45ZbqjaXs
```
* Have fun!
